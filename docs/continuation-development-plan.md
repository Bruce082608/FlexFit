...
```bash
rtk env ANDROID_HOME=/Users/fairchan/Library/Android/sdk bash ./gradlew test
rtk env ANDROID_HOME=/Users/fairchan/Library/Android/sdk bash ./gradlew assembleDebug
```
